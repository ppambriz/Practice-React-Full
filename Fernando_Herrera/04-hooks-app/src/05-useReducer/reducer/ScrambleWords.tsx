...
import confetti from "canvas-confetti"; /// -->  importación del confetti
import { getInitialState, scrambleWordsReducer } from "./ScrambleWordReducer";

export const ScrambleWords = () => {
  //el estado y el dispatch.
  const [state, dispatch] = useReducer(scrambleWordsReducer, getInitialState()); // la funcion reducer y el estadi inicial
